    ...
    <>
        ...
        <Card sx={{ maxWidth: 245 }}>
          <CardContent className={classes.jobList}>
            ...
            >
              {eachJobData.job_city} -{eachJobData.job_country}
            </Typography>
            ...
            <Typography variant="body2" className={classes.postDate}>
              Post:{" "}
              {new Date(
                eachJobData.job_posted_at_datetime_utc
              ).toLocaleString()}
            </Typography>
            ...
            <Typography variant="body2" className={classes.postDate}>
              Expire:{" "}
              {new Date(
                eachJobData.job_offer_expiration_datetime_utc
              ).toLocaleString()}
            </Typography>
            ...
            <Box display="flex" justifyContent="space-between">
              <Button
                ...
                onClick={() =>
                  window.open(eachJobData.job_apply_link, "_blank")
                }
              >
                Apply Now
              </Button>
